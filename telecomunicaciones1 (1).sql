...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-11-2024 a las 19:40:08
...
--
-- Base de datos: `telecomunicaciones1`
--
...
CREATE TABLE `contrato` (
  ...
  `detalle_contrato` varchar(200) NOT NULL,
...
CREATE TABLE `direcciones` (
  ...
  `id_parroquia` int(50) NOT NULL,
  `direccion_principal` varchar(200) NOT NULL,
  `id_contrato` int(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Estructura de tabla para la tabla `plan_y_servicios`
--

CREATE TABLE `plan_y_servicios` (
  `id_plan_servicio` int(50) NOT NULL,
  `id_planes` int(50) NOT NULL,
  `id_servicio` int(50) NOT NULL,
  `status` enum('activo','inactivo') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `usuario` (
  ...
  `nivel_usuario` enum('id_cliente','id_analista') NOT NULL,
...
CREATE TABLE `usuario_admin` (
  `id_usuario_admin` int(50) NOT NULL,
  `id_direccion` int(50) NOT NULL,
  `usuario` varchar(50) NOT NULL,
  `contraseña` varchar(34) NOT NULL,
  `tipo_documento` enum('V-','E-','J-') NOT NULL,
...
--
-- Indices de la tabla `plan_y_servicios`
--
ALTER TABLE `plan_y_servicios`
  ADD PRIMARY KEY (`id_plan_servicio`),
  ADD KEY `ID_PLAN` (`id_planes`),
  ADD KEY `ID_SERVICIO` (`id_servicio`);
...
ALTER TABLE `reportes`
  ...
  ADD KEY `ID_CLIENTE` (`id_cliente`),
  ADD KEY `ID_DIRECCION` (`id_direccion`),
  ADD KEY `ID_INCEDENCIA` (`id_incidencia`),
...
--
ALTER TABLE `analista`
  MODIFY `id_analista` int(50) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `contrato`
  MODIFY `id_contrato` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `direcciones`
--
ALTER TABLE `direcciones`
  MODIFY `id_direccion` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `empresa`
--
ALTER TABLE `empresa`
  MODIFY `id_empresa` int(50) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `historico`
  MODIFY `id_historico` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `incidencia`
--
ALTER TABLE `incidencia`
  MODIFY `id_incidencia` int(50) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `planes`
  MODIFY `id_planes` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `plan_y_servicios`
--
ALTER TABLE `plan_y_servicios`
  MODIFY `id_plan_servicio` int(50) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tipo_usuario`
  MODIFY `id_tipo_usuario` int(50) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `usuario_admin`
  MODIFY `id_usuario_admin` int(50) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `contrato`
  ADD CONSTRAINT `contrato_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `contrato_ibfk_2` FOREIGN KEY (`id_direccion`) REFERENCES `direcciones` (`id_direccion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `contrato_ibfk_3` FOREIGN KEY (`id_servicio`) REFERENCES `servicio` (`id_servicio`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `direcciones`
--
ALTER TABLE `direcciones`
  ADD CONSTRAINT `direcciones_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `direcciones_ibfk_2` FOREIGN KEY (`id_contrato`) REFERENCES `contrato` (`id_contrato`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `direcciones_ibfk_3` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `direcciones_ibfk_4` FOREIGN KEY (`id_ciudad`) REFERENCES `ciudades` (`id_ciudad`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `direcciones_ibfk_5` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `direcciones_ibfk_6` FOREIGN KEY (`id_parroquia`) REFERENCES `parroquias` (`id_parroquia`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `historico`
--
ALTER TABLE `historico`
  ADD CONSTRAINT `historico_ibfk_1` FOREIGN KEY (`id_contrato`) REFERENCES `contrato` (`id_contrato`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `historico_ibfk_2` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `historico_ibfk_3` FOREIGN KEY (`id_pago`) REFERENCES `pago` (`id_pago`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `incidencia`
--
ALTER TABLE `incidencia`
  ADD CONSTRAINT `incidencia_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `incidencia_ibfk_2` FOREIGN KEY (`id_reporte`) REFERENCES `reportes` (`id_reporte`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `planes`
  ADD CONSTRAINT `planes_ibfk_1` FOREIGN KEY (`id_servicio`) REFERENCES `servicio` (`id_servicio`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `plan_y_servicios`
--
ALTER TABLE `plan_y_servicios`
  ADD CONSTRAINT `plan_y_servicios_ibfk_1` FOREIGN KEY (`id_planes`) REFERENCES `planes` (`id_planes`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `plan_y_servicios_ibfk_2` FOREIGN KEY (`id_servicio`) REFERENCES `servicio` (`id_servicio`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `reportes`
--
ALTER TABLE `reportes`
  ADD CONSTRAINT `reportes_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `reportes_ibfk_2` FOREIGN KEY (`id_direccion`) REFERENCES `direcciones` (`id_direccion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `reportes_ibfk_3` FOREIGN KEY (`id_analista`) REFERENCES `analista` (`id_analista`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `reportes_ibfk_4` FOREIGN KEY (`id_incidencia`) REFERENCES `incidencia` (`id_incidencia`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `servicio`
--
ALTER TABLE `servicio`
  ADD CONSTRAINT `servicio_ibfk_1` FOREIGN KEY (`id_planes`) REFERENCES `planes` (`id_planes`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tipo_usuario`
--
ALTER TABLE `tipo_usuario`
  ADD CONSTRAINT `tipo_usuario_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tipo_usuario_ibfk_2` FOREIGN KEY (`id_analista`) REFERENCES `analista` (`id_analista`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tipo_usuario_ibfk_3` FOREIGN KEY (`id_admin`) REFERENCES `admin` (`id_admin`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `usuario_admin`
  ADD CONSTRAINT `usuario_admin_ibfk_1` FOREIGN KEY (`id_direccion`) REFERENCES `direcciones` (`id_direccion`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
